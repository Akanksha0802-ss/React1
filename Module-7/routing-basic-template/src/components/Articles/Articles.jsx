...
const dummyArticles = [
  ...
  { id: 2, title: "Smartphone Tips", views: 250, category: "electronics"},
  { id: 3, title: "Running Shoes", views: 100, category: "fashion"},
  { id: 4, title: "Washing Machine Guide", views: 150, category: "electronics"},
]
  ...
  return (
    <div>
        <h2>
            Articles
            <p>
              SortBy:{sortBy ?? (sortByViews === "true" ? "views" : "none")} |Category: {category ?? "All"}
            </p>
        </h2>  
